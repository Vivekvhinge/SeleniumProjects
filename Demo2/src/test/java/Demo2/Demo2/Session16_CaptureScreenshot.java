...
public class Session16_CaptureScreenshot {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * //takeSS is class for taking SS ,instantiate with webdriver to capture
		...
		File source=ss.getScreenshotAs(OutputType.FILE); //outputtype is type for ss output &getSSAs to get the SS & to declare the file 
