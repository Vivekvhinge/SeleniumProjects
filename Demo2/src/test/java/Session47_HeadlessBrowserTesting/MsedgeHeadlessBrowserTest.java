...
public class MsedgeHeadlessBrowserTest {
	...
	public static void main(String[] args) {
		...
		EdgeOptions options=new EdgeOptions();  //to run the browser headless use chromeoption sytax
		...
		WebDriver driver=new EdgeDriver(options);//in new chromedriver just add the object of chromeoption . to run 
